...
directorio_entrada = os.path.join(base_dir, 'conjuntos','train')  # Ruta de la carpeta que contiene las imágenes
directorio_salida_0 = os.path.join(base_dir, 'conjuntos','train','gatos')  # Carpeta de destino para imágenes cuyo nombre termina en 0 gatos
directorio_salida_1 = os.path.join(base_dir,'conjuntos','train','perros')  # Carpeta de destino para imágenes cuyo nombre termina en 1 perros
